...
users = [
    {"name": "John Doe", "birthday": "1985.12.01"},
...
upcoming_birthdays = get_upcoming_birthdays(users)
print("Список привітань на цьому тижні:", upcoming_birthdays) # Список привітань на цьому тижні: [{'name': 'John Doe', 'congratulation_date': '2024.12.02'}, {'name': 'Jane Smith', 'congratulation_date': '2024.11.27'}]